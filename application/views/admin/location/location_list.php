...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/announcement/');?>" data-link-data="<?php echo site_url('admin/announcement/');?>" class="mb-3 nav-link hrsale-link"> <span class="sw-icon ion ion-md-megaphone"></span> <?php echo $this->lang->line('left_announcements');?>
      ...
      <li class="nav-item clickable"> <a href="<?php echo site_url('admin/questionnaire/');?>" data-link-data="" class="mb-3 nav-link hrsale-link"> <span class="sw-icon ion ion-md-business"></span> <?php echo "Questionnaire";?>
      <div class="text-muted small"><?php echo "Create Questions";?> </div>
      </a> </li>
      <li class="nav-item clickable"> <a href="<?php echo site_url('admin/questionnaire/');?>" data-link-data="" class="mb-3 nav-link hrsale-link"> <span class="sw-icon ion ion-ios-archive"></span> <?php echo "Questionnaire Response";?>
