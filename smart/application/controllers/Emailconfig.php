...
class Emailconfig extends Admin_Controller {
    ...
    {
        $this->mailer->send_mail('wasaybaba90@gmail.com', 'Smart School Email Test', 'Smart School Email Test Successful.');
        $array = array('status' => 'success', 'error' => $this->mailer->send_mail('wasaybaba90@gmail.com', 'Smart School Email Test', 'Smart School Email Test Successful.')
        , 'message' => 'Test Email Sent Successfully. Please check your email inbox if you have received.');
