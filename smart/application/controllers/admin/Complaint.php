...
class Complaint extends Admin_Controller {
    ...
    public function index() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['complaint_list_closed'] = $this->complaint_Model->complaint_list_close();
            $data['complaint_list_new'] = $this->complaint_Model->complaint_list_new();
            $data['complaint_type'] = $this->complaint_Model->getComplaintType();
            $data['complaintsource'] = $this->complaint_Model->getComplaintSource();
            $data['complaint_status'] = $this->complaint_Model->getComplaintStatus();
            ...
            $complaint = array(
                ...
                'status' => $this->input->post('complaintstatus')
            );
