...
class Parents extends Parent_Controller
{
    ...
    public function getexams($id = null)
    {
        ...
        $data['exam_result'] = $this->examgroupstudent_model->searchStudentExams($student['student_session_id']);
        $examSchedule = $this->examgroupstudent_model->studentExams($student['student_session_id']);
        $data['examSchedule'] = $examSchedule;
//        $data['examSchedule'] = array();
        $data['student'] = $student;
        echo count($data['examSchedule']);
    ...
    public function getexamscheduledetail()
    {
        ...
        //echo count($subjects['subject_list']);
