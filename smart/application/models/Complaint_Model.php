...
class complaint_Model extends MY_Model {
    ...
    public function complaint_list($id = null) {
        ...
        if ($id != null) {
            ...
            $this->db->where('complaint.status =',$statuss);
    ...
    function getComplaintStatus() {
        $this->db->select('*');
        $this->db->from('comaplaint_status');
        $query = $this->db->get();
        return $query->result_array();
    }


    public function complaint_list_close($id = null) {
        $statuss = 'Closed';
        $this->db->select()->from('complaint');
        if ($id != null) {
            $this->db->where('complaint.id', $id);
    ...
    public function complaint_list_new($id = null) {
        $statuss = 'New';
        $this->db->select()->from('complaint');
        if ($id != null) {
            $this->db->where('complaint.id', $id);
