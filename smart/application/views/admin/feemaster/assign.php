                                            ...
                                            <div class="table-responsive">
                                                ...
                                                foreach ($feegroupList as $feegroup) {
                                                    ...
                                                    <h4>
                                                        ...
                                                        <a href="#" data-toggle="popover" class="detail_popover"><?php echo "Fess Master: ".$feegroup->group_name; ?></a>
                                                    </h4>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    <div class="box-body">
                        <h5>Fees Assign Sucessfully,
                            Did you want to add the Discount ?</h5>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary add_sibling" name="submit" >
                    <a href="<?php echo base_url()."/admin/feediscount"?>" style="color: white;">
                        Yes
                    </a>
                </button>
