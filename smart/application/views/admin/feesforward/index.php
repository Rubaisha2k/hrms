                                            ...
                                            <table class="table table-striped example">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text text-left"><?php echo "Months"?></th>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($student_due_fee as $due_fee_key => $due_fee_value) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text text-right"><select name="month_year[<?php echo $i;?>]" id="month_year" class="form-control">
                                                            <?php foreach($count as $j){ ?>
                                                            <option value="<?php if($j=='Select') echo $j; else echo $j.'-20'?>" selected= "selected"><?php if($j=='Select') echo $j; else echo $j;?></option>
