                                ...
                                <div class="form-group">
                                    ...
                                    <select name="complaintstatus" class="form-control">
                                        ...
                                        foreach ($complaint_status as $key => $value) {
                                            print_r($value);
                                            ?>
                                            <option value="<?php echo $value['complaint_status']; ?>"
                                                <?php if (set_value('complaintstatus', $complaint_data['complaint_status']) == $value['complaint_status']) echo "selected"; ?>>
                                                <?php print_r($value['complaint_status']); ?></option>
            ...
            ?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo "New ".$this->lang->line('complain'); ?> <?php echo $this->lang->line('list'); ?></h3>
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo "InProgress ".$this->lang->line('complain'); ?> <?php echo $this->lang->line('list'); ?></h3>
                        <div class="box-tools pull-right">
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
                    <div class="box-body">
