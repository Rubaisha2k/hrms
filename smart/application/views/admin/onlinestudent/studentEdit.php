        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary border0">
                    ...
                    <form action="<?php echo site_url("admin/onlinestudent/edit/" . $id) ?>" id="employeeform"
                          name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="border0">

                            <input type="hidden" id="student_id" name="student_id"
                                   value="<?php echo set_value('id', $student['id']); ?>"/>
                            <div class="bozero">
                                ...
                                <div class="around10">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input autofocus="" id="admission_no" name="admission_no"
                                                       ...
                                                       value="<?php echo "".$admission_no_au ?>"/>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="roll_no" name="roll_no" placeholder="" type="text"
                                                       class="form-control"
                                                       value="<?php echo set_value('roll_no', $student['roll_no']); ?>"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputFile"> <?php echo $this->lang->line('gender'); ?>
                                                    &nbsp;&nbsp;</label>
                                                <small class="req"> *</small>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="dob" name="dob" placeholder="" type="text"
                                                       ...
                                                       value="<?php echo set_value('dob', $this->customlib->dateformat(($student['dob']))); ?>"
                                                       readonly="readonly"/>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input id="cast" name="cast" placeholder="" type="text"
                                                       class="form-control"
                                                       value="<?php echo set_value('cast', $student['cast']); ?>"/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="admission_date" name="admission_date" placeholder=""
                                                       ...
                                                       value="<?php echo set_value('admission_date', $this->customlib->dateformat(($student['admission_date']))); ?>"
                                                       readonly="readonly"/>
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <?php ?>
                                                <input type="text" value="<?php echo $student["height"] ?>"
                                                       name="height" class="form-control"
                                                       value="<?php echo set_value('height', $student['height']); ?>">
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <?php ?>
                                                <input type="text" value="<?php echo $student["weight"] ?>"
                                                       name="weight" class="form-control"
                                                       value="<?php echo set_value('weight', $student['weight']); ?>">
                                                <span class="text-danger"><?php echo form_error('height'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input id="measure_date" name="measure_date" placeholder="" type="text"
                                                       class="form-control date"
                                                       value="<?php echo set_value('measure_date', $this->customlib->dateformat($student['measurement_date'])); ?>"
                                                       readonly="readonly"/>
                                                            ...
                                                            <optgroup label=" <?php echo $vehroute->route_title; ?>">
                                                                ...
                                                                if (!empty($vehicles)) {
                                                                    foreach ($vehicles as $key => $value) {
                                                                        ...
                                                                        <option value="<?php echo $value->vec_route_id ?>" <?php echo set_select('vehroute_id', $value->vec_route_id, $st); ?>
                                                                                data-fee="<?php echo $vehroute->fare; ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1"><?php echo "Guardian NIC"; ?></label>
                                                        <small class="req"> *</small>
                                                        <input id="guardian_nic" name="guardian_nic" placeholder=""
                                                               type="number" class="form-control"
                                                               value="<?php echo set_value('guardian_nic', $student['guardian_nic']); ?>"/>
                                                        <span class="text-danger"><?php echo form_error('guardian_nic'); ?></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea id="guardian_address" name="guardian_address" placeholder=""
                                                      class="form-control"
                                                      rows="4"><?php echo set_value('guardian_address', $student['guardian_address']); ?></textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="current_address" name="current_address" placeholder=""
                                                          class="form-control"><?php echo set_value('current_address', $student['current_address']); ?></textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="permanent_address" name="permanent_address" placeholder=""
                                                          class="form-control"><?php echo set_value('permanent_address', $student['permanent_address']) ?></textarea>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="bank_account_no" name="bank_account_no" placeholder=""
                                                       type="text" class="form-control"
                                                       value="<?php echo set_value('bank_account_no', $student['bank_account_no']); ?>"/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="bank_name" name="bank_name" placeholder="" type="text"
                                                       class="form-control"
                                                       value="<?php echo set_value('bank_name', $student['bank_name']); ?>"/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="ifsc_code" name="ifsc_code" placeholder="" type="text"
                                                       class="form-control"
                                                       value="<?php echo set_value('ifsc_code', $student['ifsc_code']); ?>"/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="adhar_no" name="adhar_no" placeholder="" type="text"
                                                       class="form-control"
                                                       value="<?php echo set_value('adhar_no', $student['adhar_no']); ?>"/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="samagra_id" name="samagra_id" placeholder="" type="text"
                                                       class="form-control"
                                                       value="<?php echo set_value('samagra_id', $student['samagra_id']); ?>"/>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="3" placeholder=""
                                                          name="previous_school"><?php echo set_value('previous_school', $student['previous_school']); ?></textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="3" placeholder=""
                                                          name="note"><?php echo set_value('note', $student['note']); ?></textarea>
                                                <span class="text-danger"><?php echo form_error('previous_school'); ?></span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="pull-right ptt10">
                                                    <button type="submit" class="btn btn-info" name="save"
                                                            value="save"><?php echo $this->lang->line('save'); ?></button>
                                                    <button type="submit" class="btn btn-info" name="save"
                                                            value="enroll"> <?php echo $this->lang->line('save_and_enroll'); ?></button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title title modal_title">
                    Student Created
                </h4>
            </div>
            <div class="modal-body">
                <div class="form-horizontal">
                    <div class="box-body">
                        <h5>Student Created Sucessfully,
                            Did you want to add the fees ?</h5>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary add_sibling" name="submit" >
                    <a href="<?php echo base_url()."admin/feemaster"?>" style="color: white;">
                        Yes
                    </a>
                </button>
                <button type="submit" class="btn btn-primary add_sibling" name="submit" >
                    <a href="<?php echo base_url()."admin/onlinestudent"?>" style="color: white;">
                        No
                    </a>
                </button>
