                    ...
                    <li class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('search_due_fees', 'can_view')) {
                               ...
                               <li class="<?php echo set_Submenu('studentfee/studentbulkfees'); ?>"><a href="<?php echo base_url(); ?>studentfee/studentbulkfees"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('search_due_fees_bulk'); ?> </a></li>

                                 <li class="<?php echo set_Submenu('studentfee/feevoucher'); ?>"><a href="<?php echo base_url(); ?>studentfee/feevoucher"><i class="fa fa-angle-double-right"></i> Fees Voucher </a></li>
                                <?php
                            }
