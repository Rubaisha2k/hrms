                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle"
                             src="<?php echo base_url() . $student['image'] ?>" alt="User profile picture">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                                <b><?php echo $this->lang->line('class'); ?></b> <a
                                        class="pull-right text-aqua"><?php echo $student['class']; ?></a>
                            </li>
                            <li class="list-group-item">
                    ...
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            <div class="dt-buttons btn-group btn-group2 pt5">
                                <a class="btn btn-default btn-xs dt-button" id="print" onclick="printDiv()"><i
                                ...
                                <div class="col-md-12">
                                    <div class="bgtgray">
                                        ...
                                        if ($exam_value->exam_type != "gpa") {
                                            ...
                                            <div class="col-sm-3 pull">
                                                <div class="description-block"><h5
                                                            class="description-header"><?php echo $this->lang->line('quality') . " " . $this->lang->line('points') ?>
                                                        :
                                                        <span class="description-text"><?php echo $exam_quality_points . "/" . $exam_credit_hour . '=' . number_format($exam_quality_points / $exam_credit_hour, 2, '.', ''); ?>
                                                                                                            </span></h5>
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        if ($exam_value->exam_type == "basic_system") {
                                            ...
                                            <td>
                                                ...
                                                if ($exam_result_value->get_marks < $exam_result_value->min_marks) {
                                                ?>
                                                <label class="label label-danger"><?php echo $this->lang->line('fail') ?>
                                                    <label>
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <table class="table table-striped table-bordered table-hover example">
                            ...
                            <?php if (empty($examSchedule)) {
                                ...
                                <tr>
                                    <td colspan="12"
                                        class="text-danger text-center"><?php echo count($examSchedule); ?></td>
                                </tr>
                                ...
                                foreach ($examSchedule as $exam) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="pull-right">
                                            <a class="btn btn-primary btn-xs schedule_modal" data-toggle="tooltip"
                                               title="" data-examname="<?php echo $exam->exam; ?>"
                                               data-examid="<?php echo $exam->exam_group_class_batch_exam_id; ?>">
