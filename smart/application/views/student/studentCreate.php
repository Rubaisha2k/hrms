                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input autofocus="" id="admission_no" name="admission_no"
                                                       placeholder="<?php echo "$admission_no"; ?>" type="text"
                                                       class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <button type="button" class="btn btn-sm mysiblings anchorbtn "><i
                                                                class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('sibling'); ?>
                                                    </button>
                                                </div>
                                                <div class="col-md-6">
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label><?php echo $this->lang->line('if_guardian_is'); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        if ($sch_setting->guardian_address) { ?>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" id="guardian_nic" name="guardian_nic"
                                                       placeholder=""
                                                       class="form-control"
                                                       rows="2"
                                                       value="<?php echo set_value('guardian_nic'); ?>"
                                                       maxlength="13"><?php echo set_value('guardian_address'); ?></input>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="current_address" name="current_address"
                                                                      placeholder=""
                                                                      class="form-control"><?php echo set_value('current_address'); ?><?php echo set_value('current_address'); ?></textarea>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="vehroute_id"
                                                                    ...
                                                                    foreach ($vehroutelist as $vehroute) {
                                                                        ?>
                                                                        <optgroup
                                                                                label=" <?php echo $vehroute->route_title; ?>">
                                                                            <?php
                                                ...
                                                <?php if ($sch_setting->national_identification_no) { ?>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="adhar_no" name="adhar_no" placeholder=""
                                                                   type="text" class="form-control"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary add_sibling" data-dismiss="modal">No</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>backend/dist/js/savemode.js">
</script>