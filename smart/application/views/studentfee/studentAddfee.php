                                ...
                                foreach ($studentlistbysection as $stkey => $stvalue) {
                                    if ($stvalue['section_id'] == $snvalue["section_id"]) {
                                        ...
                                        <div class="studentname">
                                            <a class=""
                                               href="<?php echo base_url() . "studentfee/addfee/" . $stvalue["id"] ?>">
                                                <div class="icon"><img
                                                            src="<?php echo base_url() . $stvalue["image"]; ?>"
                                                            alt="User Image"></div>
                    ...
                    <div class="box-body" style="padding-top:0;">
                        ...
                        <div class="row no-print">
                            <div class="col-md-12 mDMb10">
                                <a href="#" class="btn btn-sm btn-info printSelected"><i
                                ...
                                <button type="button" class="btn btn-sm btn-warning collectSelected" id="load"
                                        data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait.."><i
                                            class="fa fa-money"></i> <?php echo $this->lang->line('collect') . " " . $this->lang->line('selected') ?>
                                </button>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                ...
                                <tr>
                                    ...
                                    <th align="left"
                                        class="text text-left"><?php echo $this->lang->line('due_date'); ?></th>
                                    <th align="left"
                                        class="text text-left"><?php echo $this->lang->line('status'); ?></th>
                                            ...
                                            <td align="left" class="text text-left">
                                                ...
                                                }
                                                {
                                                    if ($discount_value['status'] == 'applied') {
                                                        ...
                                                        echo '<p class="text text-danger">' . $this->lang->line('discount_of') . " "
                                                            . $currency_symbol . $discount_value['amount'] . " " . $this->lang->line($discount_value['status']);
                                                    }
                                                }
                                                ?>
                                                        ...
                                                        /* if ($discount_value['status'] == "applied") {
                                                            ...
                                                            <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                                                <button class="btn btn-default btn-xs"
                                                                        ...
                                                                        data-toggle="modal"
                                                                        data-target="#confirm-discountdelete"
                                                                        title="<?php echo $this->lang->line('revert'); ?>">
                                                                    <i class="fa fa-undo"> </i>
                                                                </button>
                                                                <?php
                                ...
                                <tr class="box box-solid total-bg">
                                    ...
                                    <td align="left"></td>
                                    <td align="left"
                                        class="text text-left"><?php echo $this->lang->line('grand_total'); ?></td>
                                    <td class="text text-right"><?php
                                    ...
                                    <td class="text text-right"><?php
                                        ...
                                        ?></td>
                                    <td class="text text-right"><?php
                                        echo($currency_symbol . (number_format($total_deposite_amount, 2, '.', '') + number_format($total_fine_amount, 2, '.', '')));
                                        ?></td>
                                    <td class="text text-right"><?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal balanceformpopup">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3"
                                   class="col-sm-3 control-label"> <?php echo "Concession Group"; ?></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3"
                                   class="col-sm-3 control-label"><?php echo "Concession"; ?>
                                <small class="req"> *</small>
                            </label>
                            <div class="col-sm-9">
                                <div class="row">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3"
                                   class="col-sm-3 control-label"><?php echo $this->lang->line('payment'); ?><?php echo $this->lang->line('mode'); ?></label>
                            <div class="col-sm-9">
                                <label class="radio-inline">
                                    <input type="radio" name="payment_mode_fee" value="Cash in Bank"
                                           checked="checked"><?php echo "Cash in Bank"; ?>
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="payment_mode_fee"
                                           value="Cash in Hand"><?php echo "Cash in Hand"; ?>
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="payment_mode_fee"
                                           value="Cash in DD"><?php echo "Cash in DD"; ?>
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="payment_mode_fee"
                                           value="Cheque"><?php echo "Cheque"; ?>
                                </label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn cfees save_button" id="load"
                        data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <?php echo $currency_symbol; ?><?php echo $this->lang->line('collect_fees'); ?> </button>
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3"
                                   class="col-sm-3 control-label"><?php echo $this->lang->line('payment_id'); ?> </label>
                            <small class="req">*</small>
                            <div class="col-sm-9">
                ...
                if (data.status === "success") {
                    ...
                    $.each(data.discount_not_applied, function (i, obj) {
                        ...
                        if (typeof amount !== typeof undefined && amount !== false) {
                            ...
                            $('div#myFeesModal').find('input#amount').val(balance_amount); //wasay amount_fine
                            var a = $('div#myFeesModal').find('input#amount_fine').val();
                            if (a > 0) {
                                $('div#myFeesModal').find('input#amount_fine').val(balance_amount / 10);
                            }
                        } else {
                            $('div#myFeesModal').find('input#amount').val(fee_amount);
                            $('div#myFeesModal').find('input#amount_discount').prop('readonly', false).val(0);
                        }
                        discount_group_dropdown += "<option value=''>Select</option>";
                    });
